...
const (
	...
	GPT4_0314 //nolint:var-naming // This would be unreadable otherwise.
	// GPT4_32K has the same capabilities as the base gpt-4 mode but with 4x the context length.
	// Will be updated with our latest model iteration.
	GPT4_32K //nolint:var-naming // This would be unreadable otherwise.
	...
	GPT4_32K_0314 //nolint:var-naming // This would be unreadable otherwise.
)
